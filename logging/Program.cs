...
public class LoggingFrameworkDemo
{
    public static void Main(string[] args)
    {
        ...
        rootLogger.SetMinimumLevel(LogLevel.Info); // Set global minimum level to Info

        // Add a console appender to the root logger
        rootLogger.AddAppender(new ConsoleAppender(new SimpleFormatter()));
        ...
        serviceLogger.SetMinimumLevel(LogLevel.Debug); // More verbose logging for this specific service
        ...
        rootLogger.SetMinimumLevel(LogLevel.Debug);
